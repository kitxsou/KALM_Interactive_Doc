...
import {
  iHaveToGoButtonBig,
  iHaveToGoButtonSmall,
  restartButtonBig,
  restartButtonSmall,
} from "../sharedChoices.js";
...
if (window.innerWidth <= 1024) {
  ...
  choiceYesButton = new Choice(
    ...
    buttonWidthBig,
    buttonHeightBig,
    "Oh stimmt, dann mach ich das mal.",
    () => setCurrentScreen(screen3)
  );
  ...
  choiceNoButton = new Choice(
    ...
    buttonWidthBig,
    buttonHeightBig,
    "Ne, beim nächsten mal vielleicht.",
    () => setCurrentScreen(badEnd) // Trailer Bad End
  );
}
...
function show() {
  ...
  if (window.innerWidth <= 1024) {
    ...
    text(
      "Dir ist schon klar, dass du gerade Leben gefährdest? \n Willst du nicht erst eine Rettungsgasse bilden?",
      windowWidth / 2,
      windowHeight / 2
    );
